...
if (!phaseMarkText.includes("phase > 20")) errors.push("setup-saas progress marker must support 20 phases");
const workflowText = fs.readFileSync(".agents/skills/setup-saas/SKILL.md", "utf8");
if (!workflowText.includes("20 phases") || !workflowText.includes("Cloudflare domaine/DNS") || !workflowText.includes("Cloudinary") || !workflowText.includes("conformity:check")) errors.push("/setup-saas roadmap must include 20 phases, optional services and final conformity check");

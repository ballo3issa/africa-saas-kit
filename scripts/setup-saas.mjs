...
const computerUseAssistByPhase = {
  ...
  10: "Comparer le plan d’implémentation aux routes/pages réellement présentes; utiliser le navigateur pour confirmer les parcours visibles.",
  ...
  15: "Tester la Preview Vercel dans le navigateur sur mobile et desktop avant toute configuration live.",

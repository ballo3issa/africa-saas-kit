...
Le workflow `/setup-saas` guide Africa SaaS Kit en **20 phases**. Chaque phase commence par une explication simple : **à quoi sert le service**, **ce qu’il apporte au SaaS**, **s’il est obligatoire ou optionnel**, puis seulement les étapes de configuration.

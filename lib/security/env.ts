const SERVER_ONLY_PREFIXES = [
  "DATABASE_URL", "BETTER_AUTH_SECRET", "RESEND_API_KEY", "CHARIOW_", "FEDAPAY_",
  "DJOMY_", "PAYDUNYA_", "FLUTTERWAVE_", "MONEROO_", "PAYTECH_", "BICTORYS_", "STRIPE_", "UPSTASH_",
  "GOOGLE_CLIENT_SECRET", "CRON_SECRET",
  "TURNSTILE_SECRET_KEY", "CLOUDFLARE_R2_SECRET_ACCESS_KEY",
];
